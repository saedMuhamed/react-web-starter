  ...
  return (
    <div className="block sm:flex gap-0 sm:gap-10 mt-14">
      <div className="w-full sm:w-1/3 text-left">
        ...
        <div className="mb-7">
          <p className="font-general-regular text-2xl font-semibold text-primary-dark dark:text-primary-light mb-2">
          ...
          <ul className="leading-loose">
            {singleProjectData.ProjectInfo.CompanyInfo.map((info) => {
              return (
                <li
                  className="font-general-regular text-primary-dark dark:text-primary-light"
                  key={info.id}
                >
                  ...
                  <a
                    ...
                    className={
                      info.title === "Website" || info.title === "Phone"
                        ? "hover:underline text-primary-dark dark:text-primary-light cursor-pointer duration-300"
                        : ""
                    }
            ...
            {singleProjectData.ProjectInfo.SocialSharing.map((social) => {
              return (
                <a
                  ...
                  className="bg-primary-dark dark:bg-primary-light text-primary-light dark:text-primary-dark hover:text-gray-300 dark:hover:text-gray-900 p-2 rounded-lg shadow-sm duration-500"
                >
      ...
      <div className="w-full sm:w-2/3 text-left mt-10 sm:mt-0">
        ...
        {singleProjectData.ProjectInfo.ProjectDetails.map((details) => {
          return (
            <p
              key={details.id}
              className="font-general-regular mb-5 text-lg text-ternary-dark dark:text-primary-light"
            >
              {details.details}
            </p>
          );
